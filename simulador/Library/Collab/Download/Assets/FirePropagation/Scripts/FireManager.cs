...
public class FireManager : MonoBehaviour {
    ...
    void Start () {
        ...
        theIsland = GameObject.Find("VillageTerrain").GetComponent<Terrain>().terrainData;
        terrainW = theIsland.size.x;
        terrainheight = theIsland.size.z;
        terrainY = theIsland.size.y;
        trees = theIsland.treeInstances;
        ...
        if (trees.Length > 0)
        {
            ...
            {
                GameObject clone = PrefabUtility.InstantiatePrefab(theTree1) as GameObject;
                clone.transform.position = treePosToWorldPoint(trees[i].position);
            }
        }*/
        ...
        foreach (TreeInstance tree in theIsland.treeInstances)
        {
            ...
            Instantiate(theTree1, worldTreePos, Quaternion.identity);
    ...
    {
        return new Vector3(treePos.x * terrainW, treePos.y * terrainY, treePos.z * terrainheight);
    }
